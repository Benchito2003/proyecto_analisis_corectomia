...
flowchart TD
    ...
    %% Definición de clases con colores Hex oficiales del tema
    ...
    %% Estilo para las líneas (flechas) en gris claro
    ...
    %% Estilo manual para subgrafos (Fondo más oscuro)
    style LoadAudio fill:#21252b,stroke:#abb2bf,stroke-width:1px,color:#abb2bf
    style Denoise fill:#21252b,stroke:#abb2bf,stroke-width:1px,color:#abb2bf
    style SaveAudio fill:#21252b,stroke:#abb2bf,stroke-width:1px,color:#abb2bf
```
