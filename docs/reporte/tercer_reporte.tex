...
\end{table}
      ...
      \subsubsection{Descripción de Algoritmos (v2.0)}\hfill \\
        ...
        \textbf{Diagrama de flujo:} Apreciable en la figura \ref{fig:2.1-2.1.0}
    ...
    \subsection{Versión 3.0: Estimación MMSE y Enmascaramiento Adaptativo}
      ...
      \subsubsection{Descripción de Algoritmos (v3.0)}
        ...
        \paragraph{Algoritmo 3.3.0: Rehabilitación por Máscara de Transferencia Espectral}\hfill \\
        \textbf{Descripción técnica:} 
    ...
    \subsection{Versión 4.0: Implementación de Inteligencia Artificial (Propuesta)}
      ...
      \subsubsection{Descripción de Algoritmos (v4.0 - Propuesta)}
        \paragraph{Fase 1: Reconstrucción y Síntesis de Alta Fidelidad (Offline)}\hfill \\
        ...
        \paragraph{Algoritmo 4.2.0: Optimización de Preferencias (Fase 2)}\hfill \\
